...
const MeetingTypeList = () => {
    ...
    const createMeeting = async () => {
        ...
        try {
            ...
            const description = values.description || ' Instant class';
  ...
  return (
    <section className='grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4'>
        <HomeCard 
            ...
            title='New Class'
            description='Start a new instant class'
        ...
        >
            <Input 
            placeholder="Class Link" className="border-none bg-dark-2 focus-visible:ring-0 focus-visible:ring-offset-0 " onChange={(e) => setValues({...values, link: e.target.value})} />
        </MeetingModal>
    </section>
  )
}
